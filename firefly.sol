...
* 
*  Firefly - Be someone's light
*  Website -  https://fireflytoken.co
*  Twitter  - https://twitter.com/firefly_token
*  Telegram - https://t.me/fireflytoken
*  Facebook - https://www.facebook.com/fireflytoken
*/
...
contract Firefly is Context, IERC20, Ownable {
    ...
    //initial tax and fee set to 0 and changed to 5% after the presale ends as told by dxsale team
    ...
    //initially charityWalletAddress set to a wallet than after the presale charity address is changed
    ...
    uint256 private _maxTxAmount = 500000 * 10**6 * 10**9;
    ...
    constructor (address payable charityWalletAddress) public {
        ...
        // pancake live - 0x10ED43C718714eb63d5aA57B78B54704E256024E 
    ...
    function setRouterAddress(address newRouter) public onlyOwner() {
       //Thank you FreezyEx for this fix
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (!inSwap && swapEnabled && overMinTokenBalance && sender != uniswapV2Pair) {
            // We need to swap the current tokens to BNB and send to the charity wallet
